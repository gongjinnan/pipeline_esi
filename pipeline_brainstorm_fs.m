...
% 
% ele = 0.001*elect;
% ele = bst_bsxfun(@plus, ele, [128 129 128] / 1000);
% 
% eleT = cs_convert(sMri, 'mri', 'scs', ele);
...
% [newpoints,center,radius,coeffs]=pointsonsurface(sHeadBEM.Vertices,locsx,12); 
% locsx=newpoints(:,1:3);
...
% OPTIONS.BemSurf{3}.Faces = sInner.Faces;
% OPTIONS.BemSurf{2}.Faces = sOuter. Faces;
% OPTIONS.BemSurf{1}.Faces = sHead. Faces;
